...
const io = new Server(server, {
  cors: {
    origin: ['https://alumni-backend-6xcz.onrender.com', 'http://localhost:5173'],
    methods: ['GET', 'POST'],
    credentials: true,
  },
  pingTimeout: 60000,
...
// Middleware
app.use(cors({ origin: ['https://alumni-backend-6xcz.onrender.com', 'http://localhost:5173'], credentials: true }));
